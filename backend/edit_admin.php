...
$sql = "SELECT * FROM `admin` WHERE `id`='$admin_id' Limit 0, 10";
...
if (isset($_POST['add_admin'])) {
	...
	$sql = "UPDATE `admin` SET `username`='$u',`firstname`='$f',`lastname`='$l', `email`='$e' WHERE `id`='$admin_id';";
	// echo $sql;exit;
...
<?php include 'includes/header.php';?>
		<p id="breadcrumb"><a href="index.php" style="padding-left: 10px;">Home</a> &raquo; <a href="list_admin.php">Admin</a> &raquo; Update</p>
		<div class="content">

<h2>Update admin# <?= $prev_data['id'];?></h2>
...
<table>
	...
	<tr>
		<td>&nbsp;</td>
		<td><input type="submit" name="add_admin" value="UPDATE"></td>
	</tr>
</table>
</form>
